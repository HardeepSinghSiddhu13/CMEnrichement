...
@Repository
@NwElementTypeQ
public class NwElementTypeRepoImpl implements MetadataRepo<String>, CacheableRepo {
    ...
    private static final String TABLE = " NETWORK_TYPE ";
    ...
    private Integer insertOrGetFromDB(String typeName) {
        Integer id = null;
        try {
