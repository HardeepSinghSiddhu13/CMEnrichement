...
public class NwElementPropMetadataRepoImpl implements MetadataRepo<NwPropMetadata>, CacheableRepo {

    private static final Logger logger = LoggerFactory.getLogger(NwElementPropMetadataRepoImpl.class);
    ...
    private static final String TABLE = " NETWORK_ELEMENT_PROPERTY_METADATA ";
    ...
    public void initializeCache() {
        ...
        logger.info("Nw Element Prop Metadata cache : " + cache);
