...
public class InventoryPropMetadata {
    private Integer propertyMetadataId;
    private Integer typeId;
    private String name;

    public InventoryPropMetadata(Integer propertyMetadataId, Integer typeId, String name) {
        super();
    ...
    public InventoryPropMetadata(Integer typeId, String name) {
        super();
        this.typeId = typeId;
        this.name = name;
    }

    public InventoryPropMetadata() {
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        InventoryPropMetadata other = (InventoryPropMetadata) obj;
        if (name == null) {
            if (other.name != null)
                return false;
